...
for dl in date_list:
  for ml in mode_list:
    file_name ='/root/quant/data/Mid/'+target_list[0]+target_list[1]+'_'+dl+ml+'_df.pds'
...
df.to_html('/root/quant/data/Mid/mid_analyse' + target_list[0] + target_list[1] + date_list[0] +  '-' + date_list[-1] +'.html')
